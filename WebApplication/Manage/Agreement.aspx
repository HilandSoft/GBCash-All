<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Manage.Master" AutoEventWireup="true" CodeBehind="Agreement.aspx.cs" Inherits="Lina.WebApp.Manage.Agreement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table cellSpacing="0" cellPadding="0" width="650" align="center" border="0">
				...
				<tr>
					<td align="center"><strong>Please READ, SIGN, and FAX back to: 1300 138 916 or email to</strong>
						<a href="mailto:apply@cashsolution.com.au"><strong>apply@gbcash.com.au</strong></a></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<p align="center"><strong>Terms and Conditions <a href="#"></a></strong>
						</p>
					</td>
				</tr>
				<tr>
					<td class="unnamed1"><strong>PROMISE TO PAY</strong> For value received, I promise 
						to pay to Bridge Enterprises (Aust) Pty Ltd (Hereafter referred to as "Golden 
						Bridge") or to their order the Total Payable shown above until the full amount 
						of this note shall be paid. The amounts set forth in this note are not in 
						...
						effect direct debit and credit entries without any further notice to me, for 
						the amounts submitted with this note or any future electronic loans or 
						extension submissions made by me via the Fax Machine or by the Electronic Form 
						on the Golden Bridge Website. The unpaid amounts will be debited from my 
						nominated account until fully paid.
						<br>
						...
						<br>
						<strong>LATE FEE AND PENALTY INTEREST </strong>In the event of default, I agree 
						to pay all penalties including a $25.00 dishonour fee for each item returned, 
						and if the balance is not paid within 5 days of the payment due date, to pay an 
						additional $50 late fee. I understand that a Debt Collection Fee calculated to 
						be 50% of the total amount owing will be added to my outstanding amount if my 
						account is passed on to a professional Debt Collection Agency.
						<br>
						...
						with required thereto, which fees are hereby fixed at fifty percent (50%) of 
						the amount of the unpaid debt. Upon the occurrence of one or more of the 
						following events of default (1) failure to make any payments when due: (2) I 
						default under any other payment extension and/or repayment arrangement with 
						Golden Bridge; (4) Should I die, become insolvent or apply for bankruptcy or 
						other relief from creditors. I agree Golden Bridge may, at its option, declare 
						the entire unpaid balance of this Note to be due immediately and payable 
						...
						<br>
						<strong>BY SIGNING BELOW</strong> I confirm that I have read and understood the 
						Information Statement, Form 3A and Credit Guide. I acknowledge the terms and 
						conditions of this loan agreement including the Financial Table, and agree to 
						be bound by the terms and conditions of this loan agreement.</td>
				</tr>
				<tr>
					<td>
						<table cellSpacing="0" cellPadding="0" width="650" border="0">
							...
							<tr>
								<td colspan="2" align="center" height="24"><p align="center" class="unnamed1">Golden 
										Bridge Enterprises (Aust) Pty Ltd (ABN: 92 112 483 226 ACL No. 388601) PO Box 
										347, Collins Street West, VIC 8007<br>
