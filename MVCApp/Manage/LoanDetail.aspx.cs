        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    builder.Append("<tr><td>Operate:</td><td><a href=loanOperate.aspx?operate=18&id=" + str2 + ">PreApprove</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=loanapprove.aspx?id=" + str2 + ">Approve</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=loanreject.aspx?id=" + str2 + ">Reject</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=loancomplete.aspx?id=" + str2 + ">Complete</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=loandel.aspx?id=" + str2 + ">Delete</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=loanOperate.aspx?operate=22&id=" + str2 + ">BlackList</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=loanOperate.aspx?operate=24&id=" + str2 + ">Collection</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=loanpay.aspx?id=" + str2 + ">Repay</a></td></tr>");
