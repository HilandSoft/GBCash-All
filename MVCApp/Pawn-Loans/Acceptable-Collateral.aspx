...
<body>
    ...
    <div id="main">
        ...
        <div id="process" style="float: right;">
            ...
            <ul>
                <li class="contactdetials">Tel: <a href="tel:1300 137 906">1300 137 906</a></li>
        ...
        <div id="content" style="margin-left: 5px;">
            <p>                This is a list of items that we accept for collateral. By no means is this list complete, and we do reserve the right to change our policy on acceptable items at any time. If you have any questions regarding what is and is not acceptable collateral please feel free to call us at <a href="tel:1300 137 906">1300 137 906</a>.</p>
            <p>&nbsp;
